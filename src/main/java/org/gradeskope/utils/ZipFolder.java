...
public class ZipFolder {
    ...
    private void addFolderToZip(File rootPath, File srcFolder, ZipOutputStream zip, File[] excludeFiles) throws Exception {
        for (File fileName : srcFolder.listFiles()) {
            addFileToZip(rootPath, fileName, zip, excludeFiles);
        }
    }

    private void addFileToZip(File rootPath, File srcFile, ZipOutputStream zip, File[] excludeFiles) throws Exception {
